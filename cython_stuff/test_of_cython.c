...
#define __PYX_HAVE__test_of_cython
#define __PYX_HAVE_API__test_of_cython
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'test_of_cython' */
static long __pyx_f_14test_of_cython_fib(int, int __pyx_skip_dispatch); /*proto*/
#define __Pyx_MODULE_NAME "test_of_cython"
int __pyx_module_is_main_test_of_cython = 0;

/* Implementation of 'test_of_cython' */
...
static PyObject *__pyx_pf_14test_of_cython_fib(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_n); /* proto */

/* "test_of_cython.pyx":2
 * 
...
static PyObject *__pyx_pw_14test_of_cython_1fib(PyObject *__pyx_self, PyObject *__pyx_arg_n); /*proto*/
static long __pyx_f_14test_of_cython_fib(int __pyx_v_n, CYTHON_UNUSED int __pyx_skip_dispatch) {
  long __pyx_v_x;
  long __pyx_v_i;
  long __pyx_r;
 ...
 */
  while (1) {
    ...
    __pyx_t_2 = (((__pyx_v_x * __pyx_v_i) > 0) != 0);
    __pyx_t_1 = __pyx_t_2;
    __pyx_L5_bool_binop_done:;
    if (!__pyx_t_1) break;

    /* "test_of_cython.pyx":5
 * 	cdef long int x = 1, i = 2
 * 	while i <= n and x*i > 0:
 * 		x *= i             # <<<<<<<<<<<<<<
 * 		i += 1
...
/* Python wrapper */
static PyObject *__pyx_pw_14test_of_cython_1fib(PyObject *__pyx_self, PyObject *__pyx_arg_n); /*proto*/
static PyObject *__pyx_pw_14test_of_cython_1fib(PyObject *__pyx_self, PyObject *__pyx_arg_n) {
  int __pyx_v_n;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("test_of_cython.fib", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_14test_of_cython_fib(__pyx_self, ((int)__pyx_v_n));
...
static PyObject *__pyx_pf_14test_of_cython_fib(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_n) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("fib", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyInt_From_long(__pyx_f_14test_of_cython_fib(__pyx_v_n, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 2, __pyx_L1_error)
...
static PyMethodDef __pyx_methods[] = {
  {"fib", (PyCFunction)__pyx_pw_14test_of_cython_1fib, METH_O, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_test_of_cython(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_test_of_cython},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC inittest_of_cython(void); /*proto*/
PyMODINIT_FUNC inittest_of_cython(void)
#else
PyMODINIT_FUNC PyInit_test_of_cython(void); /*proto*/
PyMODINIT_FUNC PyInit_test_of_cython(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_test_of_cython(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_test_of_cython(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("test_of_cython", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_test_of_cython) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "test_of_cython")) {
      if (unlikely(PyDict_SetItemString(modules, "test_of_cython", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init test_of_cython", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init test_of_cython");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
